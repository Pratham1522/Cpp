...
using PriorityQ = std::priority_queue<Vptr,std::list<Vptr>,std::function<bool(const Vptr&,const Vptr&)>>;
...
// PriorityQ  pq(Container& data);// std::function<bool(const Vptr&,const Vptr&)> fn
...
std::vector<int> ReturnModifiedValues(Container& data, std::function<void(int)> fn);
